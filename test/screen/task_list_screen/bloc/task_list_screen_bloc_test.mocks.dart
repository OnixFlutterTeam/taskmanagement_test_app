...
// in flutter_tasks_7_3/test/screen/task_list_screen/bloc/task_list_screen_bloc_test.dart.
...
class MockTaskRepository extends _i1.Mock implements _i3.TaskRepository {
  @override
  _i4.Future<_i2.Result<List<String>>> getTasks() => (super.noSuchMethod(
        Invocation.method(
          #getTasks,
          [],
        ),
  ...
  @override
  _i4.Future<_i2.Result<bool>> addTask(String? task) => (super.noSuchMethod(
        Invocation.method(
          #addTask,
          [task],
        ),
  ...
  @override
  _i4.Future<_i2.Result<bool>> removeTask(String? task) => (super.noSuchMethod(
        Invocation.method(
          #removeTask,
          [task],
        ),
