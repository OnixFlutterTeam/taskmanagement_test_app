...
class S {
  ...
  String get taskFailureStorage {
    return Intl.message(
      'Failed to read from storage.',
      name: 'taskFailureStorage',
      desc: '',
      args: [],
    );
  }
  ...
  String get taskFailureAlreadyExist {
    return Intl.message(
      'This task already exist.',
      name: 'taskFailureAlreadyExist',
      desc: '',
      args: [],
    );
  }
  ...
  /// `This task not found.`
  String get taskFailureNotExist {
    return Intl.message(
      'This task not found.',
      name: 'taskFailureNotExist',
      desc: '',
      args: [],
    );
  }
